...
!! ZMQ_EXPORT void zmq_version (int *major, int *minor, int *patch);
    subroutine zmq_version(major,minor,patch) bind(c)
      import c_int, c_ptr
      integer(c_int), intent(inout), dimension(*) :: major
      integer(c_int), intent(inout), dimension(*) :: minor
      integer(c_int), intent(inout), dimension(*) :: patch
...
!! ZMQ_EXPORT const char *zmq_strerror (int errnum);
    function zmq_strerror(errnum) bind(c)
      ...
      character(kind=c_signed_char) :: zmq_strerror
...
!! ZMQ_EXPORT int zmq_ctx_shutdown (void *ctx_);
    function zmq_ctx_shutdown(ctx_) bind(c)
      import c_int, c_ptr
      type(c_ptr), intent(in), value :: ctx_
...
!! ZMQ_EXPORT int zmq_ctx_set (void *context, int option, int optval);
    function zmq_ctx_set(context,option,optval) bind(c)
      ...
      integer(c_int), intent(in) :: optval
...
!! ZMQ_EXPORT void *zmq_init (int io_threads);
    function zmq_init(io_threads) bind(c)
      import c_int, c_ptr
      integer(c_int), intent(in) :: io_threads
      type(c_ptr) :: zmq_init
...
!! ZMQ_EXPORT int zmq_msg_init (zmq_msg_t *msg);
    function zmq_msg_init(msg) bind(c)
      ...
      type(zmq_msg_t), intent(inout), dimension(*) :: msg
...
!! ZMQ_EXPORT int zmq_msg_init_data (zmq_msg_t *msg, void *data,    size_t size, zmq_free_fn *ffn, void *hint);
    function zmq_msg_init_data(msg,data,size,ffn,hint) bind(c)
      import c_int, c_ptr, c_size_t, zmq_msg_t, c_funptr
      type(zmq_msg_t), intent(inout), dimension(*) :: msg
...
!! ZMQ_EXPORT int zmq_msg_move (zmq_msg_t *dest, zmq_msg_t *src);
    function zmq_msg_move(dest,src) bind(c)
      import c_int, zmq_msg_t
      type(zmq_msg_t), intent(inout), dimension(*) :: dest
      type(zmq_msg_t), intent(inout), dimension(*) :: src
...
!! ZMQ_EXPORT int zmq_setsockopt (void *s, int option, const void *optval,    size_t optvallen);
    function zmq_setsockopt(s,option,optval,optvallen) bind(c)
      ...
      integer(c_size_t), intent(in) :: optvallen
...
!! ZMQ_EXPORT int zmq_getsockopt (void *s, int option, void *optval,    size_t *optvallen);
    function zmq_getsockopt(s,option,optval,optvallen) bind(c)
      ...
      integer(c_int), intent(in) :: option
      type(c_ptr), intent(in), value :: optval
      integer(c_size_t), intent(inout), dimension(*) :: optvallen
...
!! ZMQ_EXPORT int zmq_bind (void *s, const char *addr);
    function zmq_bind(s,addr) bind(c)
      ...
      type(c_ptr), intent(in), value :: s
      character(kind=c_signed_char), intent(inout), dimension(*) :: addr
...
!! ZMQ_EXPORT int zmq_sendiov (void *s, struct iovec *iov, size_t count, int flags);
    function zmq_sendiov(s,iov,count,flags) bind(c)
      import c_int, c_ptr, c_size_t
      type(c_ptr), intent(in), value :: s
      type(c_ptr), intent(inout), dimension(*) :: iov
...
!! ZMQ_EXPORT int zmq_recviov (void *s, struct iovec *iov, size_t *count, int flags);
    function zmq_recviov(s,iov,count,flags) bind(c)
      ...
      type(c_ptr), intent(in), value :: s
      type(c_ptr), intent(inout), dimension(*) :: iov
      integer(c_size_t), intent(inout), dimension(*) :: count
      integer(c_int), intent(in) :: flags
...
!! ZMQ_EXPORT int zmq_poll (zmq_pollitem_t *items, int nitems, long timeout);
    function zmq_poll(items,nitems,timeout) bind(c)
      ...
      type(zmq_pollitem_t), intent(inout), dimension(*) :: items
      integer(c_int), intent(in) :: nitems
      integer(c_long), intent(in) :: timeout
...
!! ZMQ_EXPORT char *zmq_z85_encode (char *dest, uint8_t *data, size_t size);
    function zmq_z85_encode(dest,data,size) bind(c)
      import c_int8_t, c_signed_char, c_size_t
      character(kind=c_signed_char), intent(inout), dimension(*) :: dest
      integer(c_int8_t), intent(inout), dimension(*) :: data
      integer(c_size_t), intent(in) :: size
      character(kind=c_signed_char) :: zmq_z85_encode
    end function zmq_z85_encode

!! ZMQ_EXPORT uint8_t *zmq_z85_decode (uint8_t *dest, char *string);
    function zmq_z85_decode(dest,string) bind(c)
      import c_int8_t, c_signed_char
      integer(c_int8_t), intent(inout), dimension(*) :: dest
      character(kind=c_signed_char), intent(inout), dimension(*) :: string
      integer(c_int8_t) :: zmq_z85_decode
